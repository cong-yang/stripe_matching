function [ score ] = innerDistKimia216( n_dist, n_theta, n_contsamp)
folder = 'mpeg400';
n_dist = round(n_dist);
...
%if exist(strcat('temp/',num2str(n_dist),'-',num2str(n_theta),'-',num2str(n_contsamp),'.mat'))~=2
    ...
    save(strcat('allresults_',folder,'_',num2str(n_dist),'-',num2str(n_theta),'-',num2str(n_contsamp),'.mat'),'allResults');
